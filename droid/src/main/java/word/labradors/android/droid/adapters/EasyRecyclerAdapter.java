...
import word.labradors.android.droid.adapters.debounced.DebouncedOnClickListener;
import word.labradors.android.droid.adapters.debounced.DebouncedOnLongClickListener;
...
public class EasyRecyclerAdapter extends RecyclerView.Adapter<EasyViewHolder> {
  ...
  private EasyViewHolder.OnEditChangeListener editChangeListener;
  ...
  protected void bindListeners(EasyViewHolder easyViewHolder) {
    if (easyViewHolder != null) {
      ...
      easyViewHolder.setEditChangeListener(editChangeListener);
    }
  }
  ...
  public void setEditChangeListener(final EasyViewHolder.OnEditChangeListener listener) {
    this.editChangeListener = listener;
  }
