...
public class CircleProgress extends View {
  ...
  private static final String default_data = "10000Kg";
  ...
  protected void initByAttributes(TypedArray attributes) {
    finishedColor = attributes.getColor(R.styleable.CircleProgress_circle_finished_color,
        default_finished_color);
    unfinishedColor = attributes.getColor(R.styleable.CircleProgress_circle_unfinished_color,
    ...
    circle_data = attributes.getString(R.styleable.CircleProgress_circle_data);
  ...
  public String getCircle_data() {
    return circle_data;
  }

  public void setCircle_data(String circle_data) {
    this.circle_data = circle_data;
  }
